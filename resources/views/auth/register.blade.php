                        ...
                        <div class="card bg-dark border-0 shadow-lg rounded-lg">
                            <div class="card-body p-5">
                                <h2 class="section-title text-center mb-4">
                                    <span class="font-weight-normal text-white">Create Your</span> 
                                    <b class="base--color">Account</b>
                                </h2>
                                
                                <form method="POST" action="{{ route('registerPost') }}" class="mt-4">
                                    @csrf
                                    
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name" class="form-label text-white">{{ __('Full Name') }}</label>
                                                <div class="input-group">
                                                    <span class="input-group-text bg-dark border-light">
                                                        <i class="las la-user text-white"></i>
                                                    </span>
                                                    <input id="name" type="text" class="form-control bg-dark text-white border-light @error('name') is-invalid @enderror" 
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text bg-dark border-light">
                                                        <i class="las la-phone text-white"></i>
                                                    </span>
                                                    <input id="phone" type="tel" class="form-control bg-dark text-white border-light @error('phone') is-invalid @enderror" 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="country" class="form-control bg-dark text-white border-light @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}" required autocomplete="country">
                                                    ...
                                                    {{-- <select id="country" class="form-control bg-dark text-white border-light @error('country') is-invalid @enderror" 
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="ref_code" type="text" class="form-control bg-dark text-white border-light @error('ref_code') is-invalid @enderror" 
                                                name="ref_code" value="{{ $_GET['ref'] ?? old('ref_code') }}" autocomplete="ref_code">
                                        </div>
                                        @error('ref_code')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group mt-4">
                                        <div class="form-check">
                                            <input class="form-check-input @error('agree') is-invalid @enderror" type="checkbox" id="agree" 
                                                name="agree" required {{ old('agree') ? 'checked' : '' }}>
                                            <label class="form-check-label text-white" for="agree">
                                                {{ __('I agree to the') }} <a href="#" class="base--color">Terms & Conditions</a>
                                            </label>
                                        </div>
                                        @error('agree')
                                            <span class="invalid-feedback d-block" role="alert">
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="text-white">
                                            ...
                                            <a href="{{ route('login') }}" class="base--color font-weight-bold">{{ __('Login Here') }}</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
