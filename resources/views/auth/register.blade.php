        ...
        <div class="col-lg-6">
            <div class="card bg-dark border-0 shadow-lg">
                <div class="card-body p-5">
                    <h2 class="card-title text-center text-white mb-4">{{ __('Register') }}</h2>
                    <form method="POST" action="{{ route('registerPost') }}">
                        @csrf

                        <div class="mb-3">
                            <label for="name" class="form-label text-white">{{ __('Name') }}</label>
                            <input id="name" type="text" class="form-control rounded-pill bg-dark text-white border-light @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" class="form-control rounded-pill bg-dark text-white border-light @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="phone" type="phone" class="form-control rounded-pill bg-dark text-white border-light @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone">
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            {{-- <input id="country" type="text" class="form-control rounded-pill bg-dark text-white border-light @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}" required autocomplete="country"> --}}
                            <select id="country" class="form-control rounded-pill bg-dark text-white border-light @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}" required autocomplete="country">
                        ...
                        <div class="mb-3">
                            <label for="ref_code" class="form-label text-white">{{ __('Referral Code (Optional)') }}</label>
                            <input id="ref_code" type="ref_code" class="form-control rounded-pill bg-dark text-white border-light @error('ref_code') is-invalid @enderror" name="ref_code" value="{{ $_GET['ref'] ?? old('ref_code') }}" required autocomplete="ref_code">
                            @error('ref_code')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" class="form-control rounded-pill bg-dark text-white border-light @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password-confirm" type="password" class="form-control rounded-pill bg-dark text-white border-light" name="password_confirmation" required autocomplete="new-password">
                        </div>

                        <div class="mb-3 form-check text-center">
                            <input class="form-check-input @error('agree') is-invalid @enderror" type="checkbox" id="agree" name="agree" required autocomplete="agree" {{ old('agree') ? 'checked' : '' }}>
                            <label class="form-check-label text-white" for="accepted">
                                {{ __('I have read and accepted the terms and conditions.') }}
                            </label>
                            @error('agree')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="d-grid mb-0">
                            <button type="submit" class="btn btn-primary rounded-pill">{{ __('Register') }}</button>
                        </div>
                    </form>
                </div>
            </div>
