...
<head>
    ...
    <title> Addupcoin - About</title>
    <meta name="title" Content="{{ env('APP_NAME') }} - About">
    ...
    <meta name="apple-mobile-web-app-title" content="Addupcoin - About">

    <meta itemprop="name" content="Addupcoin - About">
