                        ...
                        <div class="col-lg-6 text-center">
                            <div class="section-header">
                                <h2 class="section-title"><span class="font-weight-normal">TERMS AND CONDITIONS</h2>
                                    <p>Addupcoin.com Terms and Conditions</p>
                                </div>
                        </div>
                        <div class="col-lg-10">
                            <article>
                                ...
                                <br>
                                <p>Addupcoin.com is not available to the general public and is opened only to the qualified members whom have duly signed up successfully. The use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the Addupcoin.com and its members.   </p>
                                <br>
                                ...
                                <br>
                                <p>You agree that all information, communications, materials coming from Addupcoin.com are unsolicited and must be kept private, confidential and protected from any disclosure. Moreover, the information, communications and materials contained herein are not to be regarded as an offer, nor a solicitation for investments in any jurisdiction which deems non-public offers or solicitations unlawful, nor to any person to whom it will be unlawful to make such offer or solicitation.</p>
                                <br>
                                <p>All the data giving by a member to Addupcoin.com will be only privately used and not disclosed to any third parties. Addupcoin.com is not responsible or liable for any loss of data.</p>
                                <br>
                                ...
                                <br>
                                <p>Addupcoin.com is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to Addupcoin.com that you will not use this site in any illegal way and you agree to respect your local, national and international laws.</p>
                                <br>
                                ...
                                <br>
                                <p>Addupcoin.com reserves the right to accept or decline any member for membership without explanation.</p>
                                <br>
