...
<head>
    ...
    <title> Addupcoin - Contact</title>
    <meta name="title" Content="{{ env('APP_NAME') }} - Contact">
    ...
    <meta name="apple-mobile-web-app-title" content="Addupcoin - Contact">

    <meta itemprop="name" content="Addupcoin - Contact">
