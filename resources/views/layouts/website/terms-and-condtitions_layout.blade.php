...
<head>
    ...
    <title> Addupcoin - Terms and Condtitions</title>
    <meta name="title" Content="{{ env('APP_NAME') }} - Terms and Condtitions">
    ...
    <meta name="apple-mobile-web-app-title" content="Addupcoin - Terms and Condtitions">

    <meta itemprop="name" content="Addupcoin - Terms and Condtitions">
