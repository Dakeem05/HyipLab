...
<head>
    ...
    <title> Winpath - Terms and Condtitions</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Winpath - Terms and Condtitions">

    <meta itemprop="name" content="Winpath - Terms and Condtitions">
