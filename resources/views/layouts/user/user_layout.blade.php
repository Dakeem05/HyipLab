...
<head>
    ...
    <title> Winpath - Home</title>
    <meta name="title" Content="{{env('APP_NAME')}} - Home">

    <meta name="description" content="WinPath is a secure investment platform offering high-yield plans with daily returns. Invest in cryptocurrency, Start earning today!">
    ...
    <meta name="apple-mobile-web-app-title" content="Winpath - Home">
    
    <meta itemprop="name" content="Winpath - Home">
    <meta itemprop="description" content="WinPath is a secure investment platform offering high-yield plans with daily returns. Invest in cryptocurrency, Start earning today!">
    <meta itemprop="image" content="{{URL::asset('assets/images/seo/winpath_seo_image.png')}}">
    
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{env('APP_NAME')}}">
    <meta property="og:description" content="WinPath is a secure investment platform offering high-yield plans with daily returns. Invest in cryptocurrency, Start earning today!">
            ...
            (function($) {
                ...
                $('.investModal').click(function() {
                    ...
                    if (plan.fixed_amount > 0) {
                        ...
                        modal.find('[name=paln_id]').attr('readonly', true);
                ...
                (function ($) {
                  ...
                  function ajaxPlanCalc(planId, investAmount) {
                      $.ajax({
                          ...
                          data: {
                              planId,
                              _token:'GTIKiscvTFMqFWQY6BtJLq08Z7YGPcoMhwHmdkVf',
                              investAmount
                          },
